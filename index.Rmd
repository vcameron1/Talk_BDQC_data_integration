...
Builds on user's existing skill sets and workflows
...
Template = data + matadata + formating guide + validation rules
...
Difficult to make reproductible
]
]

.coleoteal[However, web-based visualization tools have proven effective in communicating and synthesizing the data for partners]
